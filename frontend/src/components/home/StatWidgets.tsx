      ...
      {Array.from({ length: bars }).map((_, i) => (
        <View
          ...
          style={[
            ...
            {
              height: (i + 1) * 3.6,
              backgroundColor: i < filled ? cumulus.rain : "rgba(33, 31, 27, 0.12)",
            },
          ]}
        />
      ))}
  ...
  return (
    <Canvas style={styles.gaugeCanvas}>
      ...
      <Line
        ...
        strokeCap="round"
      />
      <Circle cx={20} cy={22} r={2} color={cumulus.ink} />
    </Canvas>
  );
}
...
export function SunArc({
  ...
  return (
    <View style={{ width: W, height: H + 20, alignSelf: "center", position: "relative" }}>
      ...
      <Text style={[styles.timeText, { left: 6, bottom: 2 }]}>{sunrise}</Text>
      <Text style={[styles.timeText, { right: 6, bottom: 2, textAlign: "right" }]}>
        {sunset}
      </Text>
      <Text style={styles.sunHeader}>DAYLIGHT</Text>
    </View>
  );
}
